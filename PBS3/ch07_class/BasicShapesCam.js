...
var VSHADER_SOURCE = 
  ...
  '  float myWave = u_shiver.x * sin(10.0 * (gl_Position.y + u_shiver.y));\n' +
  '  gl_Position += vec4(myWave, 0, 0, 0);\n' +
  '  gl_PointSize = 10.0;\n' +
  '  v_Color = a_Color;\n' +
  '}\n';
...
*/
  ...
  pushMatrix(modelMatrix);     // SAVE world coord system;
	...
	gl.uniform2f(u_shiver, 0.1, (Date.now() / 2000) % (2 * Math.PI));
